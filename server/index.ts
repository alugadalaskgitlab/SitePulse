...
(async () => {
  ...
  try { await storage.ensureBoqMaterialMappings(); console.log("Startup: ensureBoqMaterialMappings — boq_material_mappings table verified/created"); } catch (e) { console.error("Pre-routes: Failed to ensure boq_material_mappings table:", e); }
