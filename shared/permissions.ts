...
export const SECTION_LABELS: Record<SectionKey, string> = {
  ...
  plant_shift_logs: "Plant Shift Logs",
  plant_heating: "Plant Heating Sessions",
  plant_equipment: "Plant Equipment Usage",
  plant_stock: "Plant Stock & Variance",
  plant_production: "Plant Production / Dispatches",
  plant_daily_reports: "Plant Daily Reports",
