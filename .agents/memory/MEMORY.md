...
- [Three database targets](dev-prod-db-split.md) — Dev app uses sitelog_dev; Publish compares managed dev heliumdb to managed production; verify all three before schema work.
