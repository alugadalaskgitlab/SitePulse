...
export default function SiteHome() {
  ...
  const canSeeDprs = sectionVisible("site_dprs");
  const canSeeMaterials = sectionVisible("site_materials");
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4">
      ...
      <div className="w-full max-w-md space-y-4">
        ...
        {!canSeeDprs && !canSeeMaterials && (
          <div className="text-center text-sm text-muted-foreground" data-testid="text-no-site-access">
            You don't have access to site reports.
          </div>
        )}
      </div>
    </div>
