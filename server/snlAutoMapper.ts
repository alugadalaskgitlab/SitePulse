...
const BOQ_CATEGORY_SECTORS: Record<BoqWorkCategory, { primary: Set<string>; secondary: Set<string> }> = {
  ...
  // Task #1240: IRRIGATION and MISCELLANEOUS (the "SDB MISCELLANEOUS" source
  // book) added as FALLBACK-ONLY (secondary, penalized) for structure-type
  // categories so SDB items with no road/structure-book match can still
  // surface a candidate (still gated by needs_review/unmapped safety net
  // downstream). Neither is ever primary for these categories.
  drainage:         { primary: new Set(["ROAD", "ROADS", "DRAINAGE"]), secondary: new Set(["IRRIGATION", "MISCELLANEOUS", "STRUCTURES", "STRUCTURE"]) },
  pipe_culvert:     { primary: new Set(["ROAD", "ROADS", "STRUCTURES", "STRUCTURE"]), secondary: new Set(["DRAINAGE", "IRRIGATION", "MISCELLANEOUS"]) },
  retaining_wall:   { primary: new Set(["STRUCTURES", "STRUCTURE", "ROAD", "ROADS"]), secondary: new Set(["IRRIGATION", "MISCELLANEOUS"]) },
  bridge_structure: { primary: new Set(["BRIDGE", "BRIDGES", "STRUCTURES", "STRUCTURE"]), secondary: new Set(["ROAD", "ROADS", "IRRIGATION", "MISCELLANEOUS"]) },
  reinforcement:    { primary: new Set(["STRUCTURES", "STRUCTURE", "BRIDGE", "BRIDGES", "ROAD", "ROADS"]), secondary: new Set(["IRRIGATION", "MISCELLANEOUS"]) },
  ...
  unknown_misc:     { primary: new Set(["ROAD", "ROADS", "STRUCTURES", "STRUCTURE", "BRIDGE", "BRIDGES", "DRAINAGE"]),
                      secondary: new Set(["IRRIGATION", "MISCELLANEOUS", "ELECTRICAL", "BUILDING", "BUILDINGS"]) },
};
